...
if [ ! -f "$JAR_PATH" ]; then
  ...
  echo "Fetching kompile-cli:kompile-cli:0.0.19 from https://kotlin.directory/..."
  # Fetch all dependencies into a classpath
  CLASSPATH=$("$COURSIER_PATH" fetch --repository https://kotlin.directory/ --repository central kompile-cli:kompile-cli:0.0.19 --classpath)
